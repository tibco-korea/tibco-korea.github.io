...
#### 3.2. Provider Application을 Git 리파지터리로 공유

<img src ="./img/bw_git5.png" width=500  >
<img src ="./img/bw_git6.png" width=800  >
<img src ="./img/bw_git7.png" width=800  >

#### 3.3 Provider Application 프로젝트 파일을 Commit & Push 하여 Git 리파지터리로 업로드
...
### 4. Jenkins에서 CI/CD를 위한 Provider Application 일부 변경

#### 4.1 Property 파일의 경로 변경
