...
1. URL : http://{Worker-node-IP}:32088/ 로 접속
<img src ="./img/jenkins_init1.png" width=800 align=left>

2. Jenkins Pod에 cat /var/jenkins_home/secrets/initialAdminPassword 명령어를 전달하여 Admin Password 얻기
...
3. 기본 추천 plugin 셋 설치하기

<img src ="./img/jenkins_init2.png" width=800 align=left>
<img src ="./img/jenkins_init3.png" width=800>

4. 기본 사용자 추가

<img src ="./img/jenkins_init4.png" width=500 align=left>

#### 1.4.  Jenkins 에 Maven 설정

1. Dashboard -> Manage Jenkins -> Global Tool Configuration 항목 들어가기
![jenkins_maven](./img/jenkins_init5.png)

2. Maven 항목에서 Maven 최신 버전을 자동 설치 
...
1. Dashboard -> Manage Jenkins -> Manage Plugins 항목 들어가기
![jenkins_maven](./img/jenkins_init7.png)

2. Available 항목에서 Blue Ocean 검색 및 설치
![jenkins_maven](./img/jenkins_init8.png)

3. Blue Ocean Plugin과 디펜던시를 가지는 연관 Plugin 자동 설치
<img src ="./img/jenkins_init9.png" width=800 align=left>
